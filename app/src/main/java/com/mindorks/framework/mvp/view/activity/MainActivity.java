...
package com.mindorks.framework.mvp.view.activity;
...
import com.mindorks.framework.mvp.view.QuestionCard;
import com.mindorks.framework.mvp.view.custom.RoundedImageView;
import com.mindorks.framework.mvp.view.base.BaseActivity;
...
//main activity view send event and recieve data through MainMvpView
    //methods insides MainMvpView
    //1-void openLoginActivity();
    //2-void showAboutFragment();
    //3-void refreshQuestionnaire(List<Question> questionList);
    //4-void reloadQuestionnaire(List<Question> questionList);
    //5-void updateUserName(String currentUserName);
    //6-void updateUserEmail(String currentUserEmail);
    //7-void updateUserProfilePic(String currentUserProfilePicUrl);
    //8-void updateAppVersion();
